...
export const ReviewsPageCTA: React.FC = () => {
  return (
    <section className="bg-[#161514] text-[#FAF8F5] rounded-xl p-8 md:p-12 relative overflow-hidden my-12 border border-[#C5A880]/20 font-sans">
      <div className="relative z-10 max-w-3xl">
        <span className="text-[#C5A880] text-xs uppercase tracking-[0.2em] font-medium block mb-3">
          THE WORK CONTINUES
        </span>
        <h2 className="font-serif text-2xl md:text-3xl lg:text-4xl text-[#FAF8F5] font-normal mb-4 leading-tight">
          Every celebration leaves something behind.
        </h2>
        <p className="text-[#5A5650] text-sm md:text-base leading-relaxed mb-8 max-w-2xl">
          Keep the relationships and reflections behind your work close, without turning them into noise.
        </p>
