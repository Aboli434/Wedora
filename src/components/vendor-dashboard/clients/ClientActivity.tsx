...
import { ClientActivity as ActivityType } from "@/data/vendorClients";
...
export const ClientActivity: React.FC<ClientActivityProps> = ({ activities }) => {
  return (
    <div className="bg-white border border-[#161514]/10 p-5 mb-8">
      ...
      {activities.length === 0 ? (
        <p className="text-xs text-[#5A5650] italic">No activity entries recorded.</p>
      ) : (
