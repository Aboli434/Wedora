...
export function GuestEmptyState({ onClearFilters }: GuestEmptyStateProps) {
  return (
    <div className="bg-[#FAF8F5] border border-[#161514]/15 p-12 text-center space-y-4 max-w-xl mx-auto my-6">
      ...
      <div className="space-y-1">
        ...
        <p className="text-xs font-sans text-[#5A5650] max-w-sm mx-auto leading-relaxed">
          Try adjusting your search query or clearing your current active filters to see your guest list again.
        </p>
      </div>
