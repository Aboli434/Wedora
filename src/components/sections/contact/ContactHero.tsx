...
export function ContactHero() {
  ...
  return (
    <Section padding="none" className="relative min-h-[60vh] sm:min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#161514]">
      ...
      >
        <Image
          src="/images/wedding/wedora-service-events.jpg"
          alt="Wedora Contact Hero — Evening courtyard wedding gathering"
          fill
          priority
          sizes="100vw"
      ...
      {/* Hero Content — Split Editorial Composition */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
          <div className="lg:col-span-8">
            ...
            <div className="overflow-hidden">
              ...
              >
                Let&apos;s start with your celebration.
              </motion.h1>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 lg:pb-2">
            ...
            >
              Tell us a little about what you&apos;re imagining. We&apos;ll take it from there.
            </motion.p>
            <p className="text-[11px] font-sans tracking-widest text-[#C5A880] uppercase mt-4 pl-6 opacity-80">
              Whether the day is still an idea or already taking shape, every celebration has a place to begin.
            </p>
          </div>
        </div>
      </Container>
