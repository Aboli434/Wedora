...
export function ServicesHero() {
  ...
  return (
    <Section padding="none" className="relative min-h-[75vh] sm:min-h-[80vh] flex items-center justify-center overflow-hidden bg-[#161514]">
      {/* Background Image */}
      <motion.div
      ...
      >
        <Image
          src={SERVICES_PAGE_DATA.hero.imageSrc}
          alt="Wedora Services Hero — Luxury Indian Wedding Setup"
          fill
          priority
          sizes="100vw"
          ...
          quality={90}
        />
        {/* Solid dark translucent overlay for text contrast */}
      ...
      <Container className="relative z-10 pt-32 pb-20 md:pt-40 md:pb-28 text-center flex flex-col items-center">
        ...
        >
          <span className="text-[11px] md:text-xs font-semibold tracking-[0.3em] uppercase text-[#C5A880] mb-4 block">
            {SERVICES_PAGE_DATA.hero.eyebrow}
          </span>
        </motion.div>
        ...
        <div className="overflow-hidden max-w-4xl">
          <motion.h1
            ...
            className="font-serif text-3xl sm:text-5xl md:text-6xl lg:text-7xl font-light text-[#FAF8F5] leading-[1.12] tracking-tight"
          >
            {SERVICES_PAGE_DATA.hero.heading}
          </motion.h1>
        </div>
        ...
        >
          {SERVICES_PAGE_DATA.hero.supporting}
        </motion.p>
      </Container>
    </Section>
  );
