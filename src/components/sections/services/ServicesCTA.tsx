...
export function ServicesCTA() {
  ...
  return (
    <Section padding="none" className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#161514]">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <Image
          src={SERVICES_PAGE_DATA.cta.imageSrc}
          alt="Wedora Services CTA — Grand Indian wedding celebration"
          fill
          sizes="100vw"
      ...
      <Container className="relative z-10 py-24 md:py-36 text-center flex flex-col items-center">
        ...
        >
          <span className="text-[11px] font-semibold tracking-[0.3em] uppercase text-[#C5A880] mb-4 block">
            {SERVICES_PAGE_DATA.cta.eyebrow}
          </span>
        </motion.div>
        ...
        >
          {SERVICES_PAGE_DATA.cta.heading}
        </motion.h2>
        ...
        >
          {SERVICES_PAGE_DATA.cta.supporting}
        </motion.p>
        ...
        >
          <Link href={SERVICES_PAGE_DATA.cta.primaryCtaHref} className="w-full sm:w-auto">
            <Button variant="primary" size="lg" className="w-full sm:w-auto">
              {SERVICES_PAGE_DATA.cta.primaryCtaText}
            </Button>
          </Link>

          <Link href={SERVICES_PAGE_DATA.cta.secondaryCtaHref} className="w-full sm:w-auto">
            <Button variant="outline" size="lg" className="w-full sm:w-auto">
              {SERVICES_PAGE_DATA.cta.secondaryCtaText}
            </Button>
          </Link>
        </motion.div>
      </Container>
