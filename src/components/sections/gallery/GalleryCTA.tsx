...
export function GalleryCTA() {
  ...
  return (
    <Section padding="none" className="relative min-h-[60vh] sm:min-h-[65vh] flex items-center justify-center overflow-hidden bg-[#161514]">
      {/* Background Image */}
      <div className="absolute inset-0 z-0">
        <Image
          src="/images/wedding/wedora-gallery-05.jpg"
          alt="Wedora Gallery Closing CTA — Sunset Pheras Ceremony"
          fill
          sizes="100vw"
      ...
      {/* Content Container */}
      <Container className="relative z-10 py-20 md:py-28 text-center flex flex-col items-center">
        {/* Eyebrow */}
        <motion.div
        ...
        >
          Every celebration has its own rhythm, details, and people worth remembering.
        </motion.p>
        ...
        >
          ...
          <Link href="/real-weddings" className="w-full sm:w-auto">
