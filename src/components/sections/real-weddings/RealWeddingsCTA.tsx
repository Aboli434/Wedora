...
export function RealWeddingsCTA() {
    ...
    <Section padding="none" className="relative min-h-[70vh] flex items-center justify-center overflow-hidden bg-[#161514]">
      ...
      <div className="absolute inset-0 z-0">
        <Image
          ...
          alt="Wedora Real Weddings CTA — Grand wedding celebration"
          fill
          sizes="100vw"
      ...
      <Container className="relative z-10 py-24 md:py-36 text-center flex flex-col items-center">
        ...
        >
          Every celebration deserves its own story.
        </motion.h2>
        ...
        >
          Bring your people, your traditions, and your way of celebrating together with Wedora.
        </motion.p>
